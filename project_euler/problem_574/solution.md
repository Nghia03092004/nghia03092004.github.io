...
We express the target quantity in terms of well-understood mathematical objects. For this problem, the Pratt certificates and primitive roots framework provides the natural language.
...
Using recursive certificate cost via p-1 factorization:
...
2. **Main computation:** Apply recursive certificate cost via p-1 factorization to evaluate the target.
