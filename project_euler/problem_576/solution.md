...
We express the target quantity in terms of well-understood mathematical objects. For this problem, the three-distance theorem and Weyl equidistribution framework provides the natural language.
...
2. **Main computation:** Apply continued fraction expansion to evaluate the target.
