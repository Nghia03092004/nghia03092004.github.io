...
We express the target quantity in terms of well-understood mathematical objects. For this problem, the combinatorial game theory framework provides the natural language.
...
Using Sprague-Grundy theorem + mex computation:
...
2. **Main computation:** Apply Sprague-Grundy theorem + mex computation to evaluate the target.
