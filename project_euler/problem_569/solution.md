...
We express the target quantity in terms of well-understood mathematical objects. For this problem, the Catalan number variants with prime constraints framework provides the natural language.
...
Using DP over mountain profiles:
...
2. **Main computation:** Apply DP over mountain profiles to evaluate the target.
