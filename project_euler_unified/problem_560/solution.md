...
We express the target quantity in terms of well-understood mathematical objects. For this problem, the Mobius inversion on column GCDs framework provides the natural language.
...
Using inclusion-exclusion over divisors:
...
2. **Main computation:** Apply inclusion-exclusion over divisors to evaluate the target.
