...
We express the target quantity in terms of well-understood mathematical objects. For this problem, the Pick's theorem and lattice polygon enumeration framework provides the natural language.
...
Using boundary lattice point optimization:
...
2. **Main computation:** Apply boundary lattice point optimization to evaluate the target.
