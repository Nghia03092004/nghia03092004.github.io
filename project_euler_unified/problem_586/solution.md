...
We express the target quantity in terms of well-understood mathematical objects. For this problem, the quadratic form theory and class numbers framework provides the natural language.
...
Using discriminant-based sieve:
...
2. **Main computation:** Apply discriminant-based sieve to evaluate the target.
