...
We express the target quantity in terms of well-understood mathematical objects. For this problem, the Mobius inversion on divisor lattice framework provides the natural language.
...
Using multiplicative function over prime powers:
...
2. **Main computation:** Apply multiplicative function over prime powers to evaluate the target.
