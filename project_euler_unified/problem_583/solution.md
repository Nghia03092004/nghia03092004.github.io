...
3. **Reduce** the computational complexity from brute-force to varies.

### Detailed Derivation

**Step 1 (Reformulation).**
We express the target quantity in terms of well-understood mathematical objects. For this problem, the Heron's formula parametrization framework provides the natural language.
...
Using rational point enumeration:
...
2. **Main computation:** Apply rational point enumeration to evaluate the target.
